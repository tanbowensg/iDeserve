...
let INIT_TASK_5_DESC = NSLocalizedString("“今日任务”是坚果计划的主页面，其中罗列了今天所有可以完成的任务。这样以来，你只需要浏览一个列表，就可以了解今天所有可以完成的任务。\n\n有两种类型的任务会自动显示在“今日任务”中：\n1. 轮到今天完成的重复任务。\n2. 最近一周将会截止的任务。\n\n另外，只要开启“在‘今日任务’中显示”选项，你也可以把别的任务显示在“今日任务”里。", comment: "")
