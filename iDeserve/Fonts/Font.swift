...
//    public static var titleCustom = Font.custom("HiraginoSansGB-W6", size: 28)
    ...
    public static var captionCustom = Font.system(size: 11, weight: .medium)
    public static var footnoteSmCustom = Font.system(size: 12, weight: .medium)
    public static var footnoteCustom = Font.system(size: 13, weight: .medium)
    public static var subheadCustom = Font.system(size: 15, weight: .medium)
    public static var bodyCustom = Font.system(size: 17)
    public static var headlineCustom = Font.system(size: 17, weight: .medium)
    public static var titleCustom = Font.system(size: 20, weight: .medium)
